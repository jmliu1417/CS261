...
void list_reverse(struct list* list) {
  /*Note: You have to use RECURSION to complete this function*/
...
/*
 * This function should count the number of nodes in a given linked list.
 *
 * Params:
 *   list - the linked list to be counted.  May not be NULL.
 * 
 * Return:
 *   This function returns the number of nodes in the given list 
 */
...
int count_recur(struct node* current){
  ...
  return 1 + (count_recur(current->next));
}
