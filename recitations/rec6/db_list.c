...
int if_empty(struct db_list* db_list){
    // if(db_list->front_sentinel->next->next == NULL && db_list->front_sentinel->next == NULL){
    //     return 1;
    // }else{
    //     return 0;
    // }
    ...
    return db_list->front_sentinel->next == db_list->back_sentinel;
}

void* get_head(struct db_list* db_list){
...
void* get_tail(struct db_list* db_list){
